...
namespace PrintProgram
{
    ...
    static class BoardPrint
    {
        ...
        /// <param name="No_Number">編號。</param>
        /// <param name="ENGSR">工程SR。</param>
        ...
        [STAThread]
        public static bool PrintLabel(string LabelPath, string WO, string PN, string VER, string QTY, string No_Number
            , string ENGSR, List<string> SNList, RadListControl List_Msg)
        {
            try
            {
                ...
                btFormat.SubStrings["VER"].Value = VER;// 設定標籤上的版本
                //btFormat.SubStrings["PC"].Value = PC; // 若有 PC 欄位可啟用
